 ...
 * 외적 특성
   ...
   * 띄어난 의술
    ...
    * 어깨 너머로 배운 동료의 치료 속도가 5%만큼 증가
      ...
      * 조향사
       * 망각의 향
        * '망각의 향'을 뿌려 현재 자신의 상태와 위치를 기록할 수 있음. 기술의 지속 시간 동안, 조향사는 그사이 벌어진 일들을 잊고 기록할 당시의 상태와 위치로 돌아갈 수 있음.
    ...
    * 감시자 보고서(캐릭터)
      ...
      * 노란 옷의 왕
       * 외적 특성
        * 공포의 형상
         * 생존자가 경계 범위 내에서 너무 오래 머물거나, 공격을 받거나, 순찰자에게 물리거나, 교정에 실패하거나, 동료가 쓰러지거나 광기의 의자에 묶이면 공포에 빠져 심연의 촉수가 나타남.
      ...
      * 사진사
       * 외적 특성
        * 사진 속 세계
         ...
         * 현실 세계의 생존자들은 사진기의 잔류 영상을 통해 사진 속 세계로 들어갈 수 있음. 생존자는 암호를 해독해 해독 진도를 쌓으 수 있지만 해독을 완성할 수는 없음.
    ...
    * 인격 구조(능력치)
     ...
     * 감시자
      ...
      * 1-1.공황
       * 부상 상태이거나, 쓰러져 있거나, 광기의 의자에 묶여 있는 생존자 한 명당 다른 모든 생존자의 해독, 치료 파괴 속도가 3% 감소함. 효과 중첩 가능
      ...
      * 4-3-2.추적
       * 생존자를 15/12/10초 동안 계속해서 추격하면 10%만큼의 이동 속도 보너스를 얻음. 추격에 실패하거나, 특수 모션을 하거나, 공격을 하거나, 기절하면 이동 속도가 원래대로 돌아옴.
